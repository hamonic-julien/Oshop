<footer class="main-footer">
    ...
    <div id="footer-services" class="py-5">
      <div class="container">
        <div class="row">
          <div class="d-flex col-lg-4 service-column">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php foreach ($arrayFooterTypes as $footerType): ;?>
                <li> <a href="<?= $this->baseUrl;?>/catalogue/type/<?= $footerType->getId();?>" class="text-muted"><?= $footerType->getName() ;?></a></li>
              <?php endforeach;?>
            </ul>
          </div>
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php foreach ($arrayFooterBrands as $footerBrand): ;?>
                <li> <a href="<?= $this->baseUrl;?>/catalogue/brand/<?= $footerBrand->getId();?>" class="text-muted"><?=$footerBrand->getName();?></a></li>
              <?php endforeach;?>
            </ul>
          </div>
          <div class="col-lg-4">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
              <li class="list-inline-item">
                <img src="<?= $this->baseUrl;?>/assets/img/visa.svg" alt="carte visa" class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="<?= $this->baseUrl;?>/assets/img/mastercard.svg" alt="master carte" class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="<?= $this->baseUrl;?>/assets/img/paypal.svg" alt="paypal" class="payment-icon">
              </li>
            </ul>
          </div>
        </div>
...
//]]></script>
  ...
  <script src="<?= $this->baseUrl;?>/assets/js/popper.min.js"></script>
  <script src="<?= $this->baseUrl;?>/assets/js/bootstrap.min.js"></script>
  <script src="<?= $this->baseUrl;?>/assets/js/owl.carousel.min.js"></script>
  <script src="<?= $this->baseUrl;?>/assets/js/app.js"></script>
</body>

</html>
<!--
        <a href="<?= $page->facebook->shareUrl;?>"><li>Facebook</li></a>
        <a href="<?= $page->twitter->shareUrl;?>"><li>Twitter</li></a>
        <a href="<?= $page->pinterest->shareUrl;?>"><li>Pinterest</li></a>
-->